...
//
// This version is modified for symbolic execution with KLEE
...
//   SSS    EEEEEEE     T       UUU    P      
	...
	klee_make_symbolic(jpg_buffer, jpg_size + 100, "__arr8__jpg_buffer");
	klee_track_error(jpg_buffer, "__arr8__jpg_buffer_error");
...
// DDDD       OOO    N     N  EEEEEEE
	...
	// The following original code indicates that the output is
	// bmp_buffer
